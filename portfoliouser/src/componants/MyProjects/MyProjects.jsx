...
const MyProjects = () => {
  const projectItem = (project) => {
    ...
    const classNameo = project.projectclass;
    return (
      <div
        key={project.id}
        className={`${
          keysss == 0
            ? `MyProjContCardTitle ${classNameo}`
            : `MyProjContCard ${classNameo}`
        }`}
      >
        <img src={project.imgSrc} alt="" />
        <h3>{project.title}</h3>
        <div className="projectLogo">
          <img src={project.logoimag} alt="" />
        </div>
        ...
        <div>
          {keysss == 0 ? (
            ...
            <>
            <NavLink to={`/myproject/${project.id}`}
                className="btn custom-btn"
                download
              >
                <i className="uil uil-file-alt"></i> Show Project
              </NavLink>
            </>
          )}
        </div>
      ...
      <div className="container">
        <div className="MyProjCont">
          ...
          <NavLink to={`myproject`}>
              <button class="cta">
                <span class="span">Show  All Project</span>
                <span class="second">
                  <svg
                    width="50px"
                    height="20px"
